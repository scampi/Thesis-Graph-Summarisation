\begin{figure}
	...
	\resizebox{\textwidth}{!}{
		...
		\begin{axis}[
			ybar,
			symbolic x coords={$G:\mathcal{S}_{fbt}$,$G:\mathcal{S}_{ut}$,$G:\mathcal{S}_{t}$,$G:\mathcal{S}_{a}$,$G:\mathcal{S}_{at}$,$G:\mathcal{S}_{ioa}$,$G:\mathcal{S}_{ioat}$},
			enlargelimits=0.15,
