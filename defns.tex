...
\newglossaryentry{edesc}{plural={Entity descriptions},name={Entity description},symbol={\ensuremath{\mathcal{E}}},description={the set of edges that describe an entity}}
...
\newglossaryentry{ft-bisimulation-summary}{symbol={\ensuremath{\mathcal{S}_{ft}}},name={FT-Bisimulation summary},parent={gsummary},description={graph summarisation which \gls{summarisation-relation} is based on the bisimulation relation taking also into consideration the set of types}}
