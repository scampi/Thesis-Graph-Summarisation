...
\usetikzlibrary{backgrounds,calc,shapes.geometric,patterns}
...
\newcommand{\phase}[2]{
\stepcounter{involv}
\node[phase appearance,#1, trapezium stretches,minimum width=#2]
 (phase-\theinvolv)
 at ($(\timespan-\initialweek)!.5!(\timespan-\endweek)$){};
}
