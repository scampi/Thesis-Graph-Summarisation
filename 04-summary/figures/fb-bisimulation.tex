...
\node [draw,circle,below of = n1,yshift=-.75cm] (n2) {$H_2$};
\node [draw,circle,right of = n1] (n3) {$H_3$};
\node [draw,circle,right of = n3] (n6) {$H_6$};
\node [draw,circle,below of = n6,yshift=-.75cm] (n4) {$H_4$};
\node [draw,circle,right of = n6] (n7) {$H_7$};
\node [draw,circle,right of = n4] (n5) {$H_5$};
