...
\node [draw,circle,right of = b] (h1) {$H_1$};
\node [draw,circle,above right of = h1] (h2) {$H_2$};
\node [draw,circle,below right of = h1] (h3) {$H_3$};
\node [draw,circle,above right of = h3] (h4) {$H_4$};
...
(h2) edge node[fill=white] {\gls{atype}} (city)
(h4) edge node[near end,fill=white] {\gls{atype}} (country)
(h4) edge node[fill=white] {\gls{atype}} (place)
(h3) edge node[fill=white] {\gls{atype}} (place)
