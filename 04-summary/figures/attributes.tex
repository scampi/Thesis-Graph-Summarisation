...
(n2) edge node[fill=white] {\glssymbol{atype}} (city)
(n2) edge node[fill=white] {location} (n3)
(n2) edge node[fill=white] {location} (n4)
(n2) edge node[fill=white] {\glssymbol{atype}} (place)
(n3) edge node[fill=white] {\glssymbol{atype}} (country)
(n4) edge node[fill=white] {\glssymbol{atype}} (country)
(n3) edge node[fill=white] {\glssymbol{atype}} (place)
