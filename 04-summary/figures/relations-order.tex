...
\node[draw,circle] (0) {$N_0$};
\node[draw,circle,right of = 0] (1) {$N_1$};
\node[draw,circle,right of = 1] (2) {$N_2$};
\node[draw,circle,right of = 2] (3) {$N_3$};
\node[draw,circle,right of = 3] (4) {$N_4$};
\node[draw,circle,right of = 4] (5) {$N_5$};
\node[draw,circle,right of = 5] (6) {$N_6$};
\node[draw,circle,right of = 6] (7) {$N_7$};

\node[tnode,below left of = 0,xshift=.5cm] (ath0) {$H^{at}_0$};
\node[tnode,right of = ath0] (ath1) {$H^{at}_1$};
\node[tnode,right of = ath1] (ath2) {$H^{at}_2$};
\node[tnode,right of = ath2] (ath3) {$H^{at}_3$};
\node[tnode,right of = ath3] (ath4) {$H^{at}_4$};
\node[tnode,right of = ath4] (ath5) {$H^{at}_5$};

\node[tnode,above left of = 0,xshift=.5cm] (th0) {$\mathfrak{U}^t$};
\node[tnode,draw,circle,right of = th0] (th1) {$H^{t}_1$};
\node[tnode,draw,circle,right of = th1] (th2) {$H^{t}_2$};
\node[tnode,draw,circle,right of = th2] (th3) {$H^{t}_3$};
\node[tnode,draw,circle,right of = th3] (th4) {$H^{t}_4$};
