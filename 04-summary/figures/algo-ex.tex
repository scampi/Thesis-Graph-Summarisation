...
\node at ($ (edesc) + (-2,2.25) $) {\hyperref[chap4:summary:algo:step-ed]{Step 1}};
\node at ($ (gsv) + (-2.5,2.25) $) {\hyperref[chap4:summary:algo:step-hn]{Step 2}};
\node at ($ (join2) + (-2.8,2.3) $) {\hyperref[chap4:summary:algo:step-he]{Step 3}};
