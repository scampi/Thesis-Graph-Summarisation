...
We first present a version of the algorithm for a single dataset and then for a collection of several datasets in Section~\ref{chap4:summary:algos}.
Next, we describe in Section~\ref{chap4:summary:impl} two implementations of the algorithm, one based on MapReduce~\cite{dean:2004:msd}, and the other on SPARQL.

\subsection{Algorithms}
\label{chap4:summary:algos}
...
\begin{labeling}{\textbf{\underline{Step 2:}} \emph{Node to sumnode mapping.}}
	...
	\phantomsection
	\label{chap4:summary:algo:step-ed}
	...
	\phantomsection
	\label{chap4:summary:algo:step-hn}
	...
	\phantomsection
	\label{chap4:summary:algo:step-he}
	...
	\phantomsection
	\label{chap4:summary:algo:step-stats}
...
\label{chap4:summary:alg-single-ds}
...
In the Figure~\ref{chap4:summary:tab:algo-ex}, we depict the \emph{Types} summarisation $R_t$ of a graph showing people and documents. We group the edges describing a same node in \hyperref[chap4:summary:algo:step-ed]{Step 1}. In \hyperref[chap4:summary:algo:step-hn]{Step 2} we assign the sumnode \emph{h1} to the nodes (i.e., \emph{:e1} and \emph{:e3}) of type \emph{:Person}, and \emph{h2} to the node (i.e., \emph{:e2}) of type \emph{:Document}. In \hyperref[chap4:summary:algo:step-he]{Step 3}, we join the edges of the input graph with the table created in \hyperref[chap4:summary:algo:step-hn]{Step 2} in order to retrieve the sumnodes.
It is possible to gather statistics about the summarisation in \hyperref[chap4:summary:algo:step-stats]{Step 4} by, e.g., grouping over the sumnodes and counting the number of rows in a group. Figure~\ref{chap4:summary:fig:algo-ex} depicts the \emph{Types} summary that is the output of the algorithm which execution is depicted in Figure~\ref{chap4:summary:tab:algo-ex}.
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		...
		\label{chap4:summary:tab:algo-ex}
	\end{subfigure}
	\qquad
	\begin{subfigure}{.7\textwidth}
		...
		\caption{Depiction of the \emph{Types} summary created in Figure~\ref{chap4:summary:tab:algo-ex}.}
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		...
		\label{chap4:summary:tab:id-algo-ex}
	\end{subfigure}
	\quad
	\begin{subfigure}{.8\textwidth}
		...
		\caption{Depiction of the \emph{Types} summary created in Figure~\ref{chap4:summary:tab:id-algo-ex}. The edges which provenance is A are solid red, and those which provenance is B are dashed blue.}
...
The computation of a sumnode identifier requires all the information about an entity. Since the input data consist of an edge per tuple, we need to compute the entity description \glssymbol{edesc} which is depicted by the Step~1 in the Figure~\ref{chap4:summary:fig:va-cascading}. After parsing the input data, we aggregate the tuples based on the entity $u$. Cascading provides the \emph{GroupBy} operator to do so.
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		...
		\label{chap4:summary:fig:va-cascading}
	\end{subfigure}
