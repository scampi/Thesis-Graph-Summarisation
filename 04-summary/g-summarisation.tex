...
We denote as \emph{feature} elements of the graph on which the relation of the graph homomorphism is based on. As an example, \gls{attributes} is a feature of the \gls{attributes-summary} as defined in Definition~(\ref{def:a}). In this thesis, we focus on the following features but others may be used:
\begin{itemize}
