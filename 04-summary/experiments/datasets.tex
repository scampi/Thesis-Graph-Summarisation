\begin{table}
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{lc@{\hs}rrc@{\hs}rrc@{\hs}rrc@{\hs}r}
      \toprule
      Dataset & \phantom{a} & \multicolumn{2}{c}{Schema} & \phantom{a} & \multicolumn{2}{c}{$G$} & \phantom{a} & \multicolumn{2}{c}{\glssymbol{ft-bisimulation-summary}} & \phantom{a} & $G:\glssymbol{ft-bisimulation-summary}$ \\
      \cmidrule{3-4} \cmidrule{6-7} \cmidrule{9-10} \cmidrule{12-12}
      & \phantom{a} & Types & Attributes & \phantom{a} & $\vert V \vert$ & $\vert A \vert$ & \phantom{a} & $\vert \mathcal{W}_{ft} \vert$ & $\vert \mathcal{B}_{ft} \vert$ & \phantom{a} &
      \\
