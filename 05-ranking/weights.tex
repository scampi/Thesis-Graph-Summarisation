...
In this section, we introduce several weights for the MF model. Those weights are developed specifically for improving the task of ``entity search'': given a query, retrieve the most relevant entity. We first present two query-dependent weights:
\begin{inparaenum}[(1)]
