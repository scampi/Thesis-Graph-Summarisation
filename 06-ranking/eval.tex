...
The evaluation of the leaf coverage weight LC investigates its efficiency with and without the \emph{control} function (\ref{chap6:ranking:eq:lc-norm}), where we depict the results in Figure~\ref{fig:mf-lc}.
