...
We define a graph schema model on top of a graph summary in Section~\ref{chap7:applications:wdm:graph-schema}. We describe an RDF model for a graph summary in Section~\ref{chap03:summary-rdf}.
